    ...
    <n-collapse-item title="高级事件配置" name="3">
        ...
        <n-card class="collapse-show-box">
            ...
            <div v-for="eventName in EventLife" :key="eventName">
                ...
                <p class="go-ml-4">
                    <n-code
                        :code="(targetData.events.advancedEvents || {})[eventName] || ''"
                        language="typescript"
                    ></n-code>
                </p>
                <p>}<span>,</span></p>
                        ...
                        >
                            ...
                            <p class="go-pl-3">
                                ...
                                <span class="func-keyNameWord"
                                    >{{ eventName }}(e, components, echarts, node_modules)&nbsp;&nbsp;{</span
                                >
                            </p>
                            <!-- 编辑主体 -->
                            <monaco-editor
                            ...
                            <n-scrollbar trigger="none" style="max-height: 505px">
                                ...
                                >
                                    ...
                                    <n-collapse-item title="this" :name="2">
                                        ...
                                        <n-tag
                                            class="go-m-1"
                                            v-for="prop in ['refs', 'setupState', 'ctx', 'props', '...']"
                                            :key="prop"
                                            >{{ prop }}</n-tag
                                        >
                                    </n-collapse-item>
                                    <n-collapse-item title="components" :name="3">
                                        <n-text depth="3"
                                            >当前大屏内所有组件的集合id
                                            图表组件中的配置id，可以获取其他图表组件进行控制</n-text
                                        >
                                    ...
                                    <n-collapse-item title="node_modules" :name="4">
                                        ...
                                        <br />
                                        <n-tag class="go-m-1" v-for="pkg in Object.keys(npmPkgs || {})" :key="pkg">{{
                                            pkg
                                        }}</n-tag>
                                    </n-collapse-item>
                                </n-collapse>
            ...
            <template #action>
                <n-space justify="space-between">
                    <div class="go-flex-items-center">
                        ...
                        <n-text class="go-ml-2" depth="2"
                            >通过提供的参数可为图表增加定制化的tooltip、交互事件等等</n-text
                        >
                    </div>
...
const { DocumentTextIcon, PencilIcon } = icon.ionicons5
